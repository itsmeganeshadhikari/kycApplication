...
public class AdToBsConverter {
    ...
    public static void main(String args[]) {
        AdToBsConverter englishDateToBs = new AdToBsConverter();
        try {
            System.out.println(englishDateToBs.engToNep(1987, 1, 18));//yyyy,mm,dd
        } catch (Exception e) {
    ...
    public String engToNep(int yyyy, int mm, int dd) throws Exception {
        ...
        if (chk != true) {
            System.out.println("yyyy-mm-dd" + yyyy + "-" + mm + "-" + dd);
    ...
    public int getResult(int year, int month) {
        int a = getBSDateDetail(year, month);
